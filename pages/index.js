      ...
      <main>
        ...
        >
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            {[
              { quote: '“Hussle Solutions transformed our booking process. No more missed appointments and our team loves the intuitive interface.”', author: 'Dr. Emily Carter, Greenfield Vet Clinic' },
              { quote: '“The dashboard gives us immediate visibility into patient flow and revenue. It’s like having a virtual clinic manager!”', author: 'Dr. Raj Patel, Oakwood Veterinary Services' },
            ].map((test, idx) => (
              <motion.blockquote
                key={idx}
